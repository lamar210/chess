...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_DARK_GREEN = SET_TEXT_COLOR + "65m";
    public static final String SET_TEXT_COLOR_BEIGE = SET_TEXT_COLOR + "101m";
    ...
    public static final String SET_BG_COLOR_BEIGE = SET_BG_COLOR + "223m";
    public static final String SET_BG_COLOR_BABY_GREEN = SET_BG_COLOR + "151m";
